...
format_type_link = "Plain Text UTF-8"
...
for name in books.top30:
    ...
    try:
        WebDriverWait(driver, 0.1).until(EC.presence_of_element_located((By.LINK_TEXT, format_type_link)))
        not_founded = False
    except:
        not_founded = True
    ...
    text = driver.find_element(By.LINK_TEXT, format_type_link)
    text.click()
